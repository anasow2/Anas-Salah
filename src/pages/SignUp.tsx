  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-50">
      ...
      <div className="hidden md:flex md:w-1/2 bg-slate-900 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/80 to-brand-blue/90 z-10 mix-blend-multiply"></div>
        ...
        <div className="relative z-20 flex flex-col justify-between p-12 w-full h-full">
          ...
          <div className="mb-12">
            ...
            <p className="text-white/80 text-lg font-medium max-w-md">
              Join thousands of travelers who trust SAHAL for their daily commutes and cross-country adventures.
            </p>
          </div>
            ...
            <div className="space-y-4">
              <div className="group">
                ...
                <div className="relative">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary w-5 h-5 transition-colors" aria-hidden="true" />
                  <input 
                    id="fullName"
                    type="text" 
